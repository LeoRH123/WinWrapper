...
public enum WindowMessages : uint
{
    ...
    MouseLeftButtonDown = PInvoke.WM_LBUTTONDOWN,
    LButtonUp = PInvoke.WM_LBUTTONUP,
    MouseLeftButtonUp = PInvoke.WM_LBUTTONUP,
    LButtonDBLCLK = PInvoke.WM_LBUTTONDBLCLK,
    MouseLeftButtonDoubleClick = PInvoke.WM_LBUTTONDBLCLK,
    RButtonDown = PInvoke.WM_RBUTTONDOWN,
    MouseRightButtonDown = PInvoke.WM_RBUTTONDOWN,
    RButtonUp = PInvoke.WM_RBUTTONUP,
    MouseRightButtonUp = PInvoke.WM_RBUTTONUP,
    RButtonDBLCLK = PInvoke.WM_RBUTTONDBLCLK,
    MouseRightButtonDoubleClick = PInvoke.WM_RBUTTONDBLCLK,
    MouseMiddleButtonDown = PInvoke.WM_MBUTTONDOWN,
    MButtonDown = PInvoke.WM_MBUTTONDOWN,
    MouseMiddleButtonUp = PInvoke.WM_MBUTTONUP,
    MButtonUp = PInvoke.WM_MBUTTONUP,
    MouseMiddleDoubleClick = PInvoke.WM_MBUTTONDBLCLK,
    MButtonDBCLK = PInvoke.WM_MBUTTONDBLCLK,
    MouseWheel = PInvoke.WM_MOUSEWHEEL,
    MouseXButtonDown = PInvoke.WM_XBUTTONDOWN,
    XButtonDown = PInvoke.WM_XBUTTONDOWN,
    MouseXButtonUp = PInvoke.WM_XBUTTONUP,
    XButtonUp = PInvoke.WM_XBUTTONUP,
    XButtonDBLCLK = PInvoke.WM_XBUTTONDBLCLK,
    MouseXButtonDoubleClick = PInvoke.WM_XBUTTONDBLCLK,
    MouseHorizontalWheel = PInvoke.WM_MOUSEHWHEEL,
